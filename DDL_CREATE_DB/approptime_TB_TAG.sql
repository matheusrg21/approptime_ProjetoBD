...
CREATE TABLE `TB_TAG` (
  ...
  PRIMARY KEY (`ID`),
  KEY `fk_TB_TAG_TB_USUARIO_idx` (`ID_USUARIO`),
  CONSTRAINT `fk_TB_TAG_TB_USUARIO` FOREIGN KEY (`ID_USUARIO`) REFERENCES `TB_USUARIO` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `TB_TAG` VALUES (3,'Projeto1',1);
