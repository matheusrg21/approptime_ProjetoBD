...
CREATE TABLE `TB_TAREFA` (
  ...
  PRIMARY KEY (`ID`),
  KEY `fk_TB_TAREFA_TB_USUARIO_idx` (`ID_USUARIO`),
  CONSTRAINT `fk_TB_TAREFA_TB_USUARIO` FOREIGN KEY (`ID_USUARIO`) REFERENCES `TB_USUARIO` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `TB_TAREFA` VALUES (1,1,'Template wmais'),(2,1,'Banco de dados');
