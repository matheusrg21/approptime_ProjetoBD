...
CREATE TABLE `TB_WORKSPACE` (
  ...
  `DS_WORKSPACE` varchar(45) NOT NULL,
  `ID_USUARIO` bigint(10) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `fk_TB_WORKSPACE_idx` (`ID_USUARIO`),
  CONSTRAINT `fk_TB_WORKSPACE` FOREIGN KEY (`ID_USUARIO`) REFERENCES `TB_USUARIO` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `TB_WORKSPACE` VALUES (1,'UNB',1),(2,'CJR',1);
