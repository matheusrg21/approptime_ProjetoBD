 ...
 */
public class AutoCompleteContainsWorkspace extends JComboBox {
   ...
   public AutoCompleteContainsWorkspace() {
      super();
...
//                        return;
                     ...
                     if (Objects.nonNull(appropTimeBo) && (StringUtils.isEmpty(palavraNaoEncontrada) ||
                        ...
                        allItens = appropTimeBo.getDescricaoWorkspacesByUsuario(idUsuario);
                     }
