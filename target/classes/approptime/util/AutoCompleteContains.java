 ...
 */
public class AutoCompleteContains extends JComboBox {
...
//                        return;
                     ...
                     if (Objects.nonNull(appropTimeBo) && (StringUtils.isEmpty(palavraNaoEncontrada) ||
                        ...
                        allItens = appropTimeBo.getDescricaoTarefasByRelevancia(tc.getText(), idUsuario);
                     }
